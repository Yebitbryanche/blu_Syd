...
const FilterContent = ({ items }: Props) => {
  return (
    <View>
      ...
      <ScrollView horizontal className="pt-3">
        <View className="flex flex-row gap-x-4">
          {items.map((item, index) => (
            <TouchableOpacity
              className="rounded-xl w-[219px] h-[198px] overflow-hidden"
              key={index}
            >
              ...
              <View className="absolute bottom-0 p-2 flex-col items-center gap-y-3">
                ...
                <TouchableOpacity className="bg-gray-200 p-3 rounded-full w-[120px] items-center">
